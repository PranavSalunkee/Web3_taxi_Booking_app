...
import 'package:taxi_book/DriverDashboard.dart';
import 'package:taxi_book/home/home.dart';
import 'package:flutter_easyloading/flutter_easyloading.dart';
import 'package:flutter/material.dart';
import 'package:taxi_book/utils/CustomColors.dart';
import 'package:taxi_book/utils/CustomTextStyle.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          ...
          appBar: AppBar(
            title: Text("Login using XDC",style: TextStyle(color: Colors.black),),
                          ...
                          onPressed: () async {
                            ...
                            if (ppk.text == "") {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Please enter wallet private key!'),
                                ),
                              );
                              log("inside blank");
                            } else {
